...
==========
## About this repo
I used PyQt5 to create a GUI for [dejavu app](https://github.com/worldveil/dejavu). Features provided include:
- Recognize song from microphone
- Fingerprint new songs
- Tweak the parameters of fingerprinting algorithm
- Tweak the parameters of recognizer
